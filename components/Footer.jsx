    ...
    return (
      <footer className="container grid gap-5 pt-6 text-slate-700 md:py-10 dark:text-slate-400 ">
         <section className="grid grid-cols-2 gap-5 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3">
            ...
            <div>
               <h3 className="pb-4 font-bold">elsewhere</h3>
               <ul>
                  <li className="space-x-1 pb-4">
                     <svg viewBox="0 0 438.549 438.549" className="inline size-4">
                     ...
                     <a target="_blank" rel="noreferrer" href="https://github.com/amaninders" className="decoration-dotted underline-offset-8 hover:underline">github</a>
                  </li>
                  <li className="space-x-1 pb-4">
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="inline size-4">
                     ...
                     <a target="_blank" rel="noreferrer" href="https://www.instagram.com/amaninderps" className="decoration-dotted underline-offset-8 hover:underline">instagram</a>
                  </li>
               </ul>
            </div>
         </section>
